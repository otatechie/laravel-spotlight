...
/**
 * Example Custom Rule for Laravel Beacon
 *
 ...
 * To use this rule:
 *
 * 1. Copy this file to app/Beacon/Rules/ExampleCustomRule.php
 * 2. Update the namespace to match your application structure
 * 3. Customize the scanning logic in the scan() method
 * 4. Register it in config/beacon.php:
 *
 *    return [
 *        'custom_rules' => [
 *            \App\Beacon\Rules\ExampleCustomRule::class,
 *        ],
 *    ];
 *
 * 5. Run: php artisan beacon:scan
 */
